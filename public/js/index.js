...
(function() {
  ...
  //  //  var path = 'problems/phones.json';
  //  //  $.getJSON(path, function(data) {
  //  //    // $('.problemText').val(JSON.stringify(data, null, 2)).change();
  //     myProblemObj = !{JSON.stringify(prbdata)};
  //     // myProblemObj = #{prbdata};
  //     console.log(myProblemObj);
  //  // });
  //  }
  ...
  function onAnalyzeClick() {
    ...
    var problemJson = myProblemObj;//getJsonFromElement($('.problemText'));
    if (!problemJson)
      return;
